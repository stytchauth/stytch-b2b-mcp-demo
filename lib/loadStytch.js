...
In this example, we use the Backend SDK in getServerSideProps for the protected page /dashboard which can only be viewed if the user has an active Stytch session.
*/
const loadStytch = () => {
  if (!client) {
